...
os.remove("pgblog.txt")

print("Note: Read The Content In The Below Links Carefully")
print("\nTerms and Conditions: https://telegra.ph/Terms-and-Conditions-10-04")
print("\nDisclaimers: https://telegra.ph/Disclaimers-for-Members-Adder-10-04")

password = "pgbgroup"

while password!= "Pgbgroup":
  password = input('\nPassword:')
wt = (
    ''' 
     _____      _                                 
 |  __ \    | |                                
 | |__) |_ _| |__   __ _ _ __ ___  _   _ _ __  
 |  ___/ _ | ' \ /  | '__/ _ \| | | | '_ \ 
 | |  | (_| | |_) | (_| | | | (_) | |_| | |_) |
